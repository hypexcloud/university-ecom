        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-prestige-gray-300">
              Drei Optionen für Ihren Erfolg · Alle Preise inkl. 19% MwSt.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {course.plans.map((plan) => {
              ...
              return (
                <Card
                  key={plan.id}
                  className={`card-prestige text-center relative ${isPopular ? 'border-prestige-gold-500 shadow-gold' : ''}`}
                >
                  {isPopular && (
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="space-y-3">
                      <Button asChild className={isPopular ? 'btn-gold w-full' : 'btn-prestige w-full'}>
